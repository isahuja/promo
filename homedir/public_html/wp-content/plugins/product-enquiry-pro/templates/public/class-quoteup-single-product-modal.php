...
class QuoteupSingleProductModal
{
    ...
    private function cssHTML($manual_css, $prod_id, $color, $title, $uemail, $img_url, $price, $url, $product_id, $form_data)
    {
        ...
        ?>
                            <!--<div class='ck_msg wdm-enquiry-form-indication'><sup class='req'>*</sup> <?php _e('Indicates required fields', QUOTEUP_TEXT_DOMAIN) ?></div>-->
    ...
    ?>
                            ...
                            <div class="form_input btn_div wdm-enquiryform-btn-wrap wdm-quoteupform-btn-wrap"><div class='form-wrap'><input type='submit' value='<?php _e('Send', QUOTEUP_TEXT_DOMAIN);
        ...
        ?><img src='<?php echo $url ?>' ></div></div></div>
                        ...
                        <div id="success_<?php echo $prod_id ?>" class="wdmquoteup-success-wrap">
                            ...
                            <div class='success_msg'>
                                <span class="wdm-quoteupicon wdm-quoteupicon-done"></span> <strong><?php _e('Enquiry email sent successfully!', QUOTEUP_TEXT_DOMAIN) ?></strong>
                            </div>
                        </div>
    ...
    private function displaySendMeACopy($enable_mc)
    {
        if ($enable_mc == 1) { ?>
            ...
            ?>><input type='checkbox' id='contact-cc'  name='cc' value='yes'  /><span class='contact-cc-txt'><?php _e('Send me a copy', QUOTEUP_TEXT_DOMAIN) ?></span></label>
                        </div>
                        <?php
        }
    }
