...
class QuoteupEnquiriesEdit extends Abstracts\QuoteupEdit
{
    ...
    public function displayEnquiryHeading($enquiry_details)
    {
        ...
        echo esc_html('Enquiry Details', QUOTEUP_TEXT_DOMAIN).' #'.$enquiryId;
    }
    ...
    public function enquiryTable()
    {
        ...
        ?></th>
                        <th class="wdmpe-detailtbl-head-item item-head-cost"><?php echo __('Price', QUOTEUP_TEXT_DOMAIN);
        ?></th>
                        <th class="wdmpe-detailtbl-head-item item-head-qty"><?php echo __('Quantity', QUOTEUP_TEXT_DOMAIN);
        ?></th>
                        <th class="wdmpe-detailtbl-head-item item-head-cost"><?php echo __('Total price', QUOTEUP_TEXT_DOMAIN);
        ?></th>
            ...
            foreach ($enquiryProducts as $prod) {
                ...
                $deletedClass = '';
                    ...
                    if (isset($prod['variation_id']) && $prod['variation_id'] != '' && $prod['variation_id'] != 0) {
